<!-- Get NAS by pasting 2 commands to Startup Applications. Drop stuff in your Public folder, it'll be saved by your NAS--another normal computer with a normal OS, and no systemd! -->
